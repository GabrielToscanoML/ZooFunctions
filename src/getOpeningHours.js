...
// console.log(getOpeningHours('Wednesday', '09:00-PM'));
...
// console.log(getOpeningHours('Sunday', '09:c0-AM'));
// console.log(getOpeningHours('Monday', '13:00-AM'));
// console.log(getOpeningHours('Tuesday', '09:60-AM'));
